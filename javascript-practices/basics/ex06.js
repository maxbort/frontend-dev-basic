 ...
 *
 * 1. 자바 스크립트 객체는 function 타입과 object 타입 딱 2가지가 있다.
 * 2. 보통, function 타입의 객체는 "함수"라고 부른다.
 * 3. 따라서 자바스크립트 객체라고 부르는 것은 object타입의 객체를 가리킨다.
 * 
 * 
 * 생성방법1
 * 생성자 함수를 사용하는 방법
...
// XmlHttpRequest 객체를 사용해서 통신(AJAX) -> aynchronous javascript and xml
